...
class DetailTransaksiController extends Controller
{
    public function show($id_transaksi)
    {
        ...
        return view('kasir.detail_transaksi_lihat', compact('transaksi', 'service_fee', 'total_to_be_paid','lowStockProducts'));
    }
    ...
    public function tambahDetailProduk(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kasir.detail.show', $validatedData['id_transaksi'])
                ...
                ->with('alert', 'Data berhasil disimpan!');
        } catch (\Exception $e) {
            DB::rollBack();
            ...
            return redirect()->back()
                ...
                ->with('alert', 'Data gagal disimpan!')
                ->withInput();
        }
    }
    ...
    public function update(Request $request, $id_transaksi, $no_produk)
    {
        ...
        return redirect()->route('kasir.detail.show', $id_transaksi)
                         ...
                         ->with('alert', 'Data berhasil diperbarui!');
    }
    ...
    public function hapusProdukDetailTransaksi($id_transaksi, $no_produk)
    {
        ...
        $produk = Produk::findOrFail($no_produk);
        $produk->increment('stok', $detailProduk->qty); // Menggunakan qty dari detail produk yang dihapus

        // Update total harga setelah menghapus produk
        $this->updateTotalHarga($id_transaksi);
