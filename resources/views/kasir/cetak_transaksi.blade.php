...
<body class="bg-gray-100">
    <div class="bg-white p-6 mx-auto rounded-lg shadow-lg max-w-4xl">
        ...
        <div class="flex justify-between items-start mb-4">
            ...
            <div class="w-2/3">
                <div class="flex items-center mb-2">
                    <img src="{{ asset('logo.jpg') }}" alt="Logo Bengkel" class="w-20 h-20 mr-4">
                    <div>
                        ...
                        <p class="text-sm">Wa: 0877-3160-3908</p>
                        <p class="text-sm mt-2">ID TRANSAKSI: <span class="font-semibold">{{ $transaksi->id_transaksi }}</span></p>
                        <p class="text-sm mt-2">keterngan service : <span class="font-semibold">{{ $transaksi->Keterangan_Service }}</span></p>
            ...
            <div class="w-1/3 text-sm">
                <p>Kepada Yth,</p>
                <p class="font-semibold">{{ $transaksi->nama_pelanggan }}</p>
                <p>{{ $transaksi->tanggal_transaksi ?? 'Alamat tidak tersedia' }}</p>
        ...
        <div class="text-right text-sm mb-4">
            <p><strong>Servis:</strong> Rp {{ number_format($service_fee, 0, ',', '.') }}</p>
